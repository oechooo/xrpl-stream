...
module.exports = {
  ...
  channel: {
    ...
    // Minimum channel amount in drops (prevent dust channels)
  ...
  streaming: {
    // Default rate in drops per second
    DEFAULT_RATE_PER_SECOND: '1000', // 0.001 XRP per second
    
    // Minimum rate in drops per second
    MIN_RATE_PER_SECOND: '1',
    
    // Maximum rate in drops per second (prevent abuse)
    MAX_RATE_PER_SECOND: '100000', // 0.1 XRP per second
